...
namespace QueHice.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly QueHiceDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = QueHiceConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QueHiceDbContext context)
        {
            _context = context;
        }
